...
- `docs/public/screenshots/user/users-desktop-en.jpg`;
- `docs/public/screenshots/user/user-detail-desktop-vi.jpg`;
- `docs/public/screenshots/user/role-permissions-desktop-en.jpg`;
- `docs/public/screenshots/user/profile-mobile-vi.jpg`;
- `docs/public/screenshots/user/invitation-mobile-vi.jpg`.
