...
- `docs/public/screenshots/partner-directory-vi-desktop.png`;
- `docs/public/screenshots/partner-detail-en-mobile.png`;
- `docs/public/screenshots/partner-accounting-vi-mobile.png`.
