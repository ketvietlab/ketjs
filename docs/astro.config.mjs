          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Persistent island evidence', slug: 'ketjs/evidence/persistent-islands' },
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { label: 'Collaboration browser evidence', slug: 'ketsuite/evidence/collaboration' },
                { label: 'Loyalty browser evidence', slug: 'ketsuite/evidence/loyalty' },
                { label: 'Loyalty benchmarks', slug: 'ketsuite/benchmarks/loyalty' },
                {
                  label: 'Hospitality company catalog',
                  slug: 'ketsuite/evidence/hospitality/company-catalog',
                },
                {
                  label: 'Hospitality header regression',
                  slug: 'ketsuite/evidence/hospitality/header-regression',
                },
                {
                  label: 'Hospitality Website handoff',
                  slug: 'ketsuite/evidence/hospitality/website-handoff',
                },
              ],
            },
          ],
