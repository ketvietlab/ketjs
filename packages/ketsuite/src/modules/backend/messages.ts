...
export const messages: Record<string, Record<string, Message>> = {
  vi: {
    ...
    // The search-filter bar's own words. Every list that adopts the bar shows the
    // same chrome, so only its label and placeholder stay with the module.
  ...
  en: {
    ...
    'search.customFilterOperator': 'Condition',
    ...
    'search.clear': 'Clear',
    'search.applyError': 'The filter could not be applied',
