...
export default defineModule({
  ...
  menus: {
    stock: { label: 'menu.app', icon: 'warehouse', sequence: 25 },
    'stock.transfers': {
      parent: 'stock',
    ...
    'stock.replenishment': {
      ...
      path: '/admin/stock/replenishment',
      needs: 'stock.listOrderpoints',
      sequence: 1040,
    },
    'stock.config': { parent: 'stock', label: 'menu.config', sequence: 2000 },
    'stock.warehouses': {
      parent: 'stock.config',
      label: 'menu.warehouses',
      path: '/admin/stock/warehouses',
    ...
    'stock.pickingTypes': {
      ...
      path: '/admin/stock/picking-types',
  ...
  messages: {
    vi: {
      ...
      'transfer.list.records.hint': 'Các trường vận hành cốt lõi của danh sách dịch chuyển.',
      ...
      'stockRoute.list.records.hint': 'Danh sách tuyến kho theo thứ tự ưu tiên.',
      ...
      'location.configured.hint': 'Tên đầy đủ, loại vị trí và kho liên kết.',
      ...
      'pickingType.configured.hint': 'Các luồng nhập, xuất và dịch chuyển nội bộ cốt lõi.',
    ...
    en: {
      ...
      'transfer.list.records.hint': 'Core operational fields for stock transfers.',
      ...
      'stockRoute.list.records.hint': 'Stock routes in priority order.',
      ...
      'location.configured.hint': 'Complete name, location type, and linked warehouse.',
      ...
      'pickingType.configured.hint': 'Core receipt, delivery, and internal-transfer flows.',
