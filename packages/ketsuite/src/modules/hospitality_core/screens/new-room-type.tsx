...
import { type Frame, type PolicyRow, type PropertyRow, roomTypeFeedback, roomTypeForm, type RoomTypeFormValues, Section, stack, type TemplateResult, type Translator } from './shared.tsx'
