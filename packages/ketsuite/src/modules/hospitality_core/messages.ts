...
export const messages: Record<string, Record<string, Message>> = {
  vi: {
    ...
    'validation.charge_fulfillment_kind': 'Cách hoàn tất dịch vụ không hợp lệ.',
    ...
    'validation.minibar_fulfillment_required':
      'Phí minibar chỉ được ghi sau khi connector tồn kho xác nhận xuất hàng.',
    'validation.external_fulfillment_required':
      'Dòng này cần connector tồn kho hoàn tất trước khi ghi phí vào hồ sơ.',
  ...
  en: {
    ...
    'validation.charge_source_reused': 'The charge source key was already used for different content.',
    ...
    'validation.product_required': 'Select a product before selecting a unit or fulfilment boundary.',
    'validation.charge_fulfillment_kind': 'Charge fulfilment kind is invalid.',
    ...
    'validation.minibar_fulfillment_required':
      'A minibar charge may be posted only after the stock connector confirms fulfilment.',
    'validation.external_fulfillment_required':
      'This line requires the stock connector to complete fulfilment before posting the folio charge.',
