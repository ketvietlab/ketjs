...
export const messages: Record<string, Record<string, Message>> = {
  vi: {
    ...
    'filter.needsAttention': 'Có phòng cần để mắt',
    'filter.freeCancellation': 'Được huỷ miễn phí',
    ...
    'screen.tapeChart.legendHint':
      'Màu trên lịch là trạng thái của lượt lưu trú. Mở một lượt để nhận, chuyển hoặc trả phòng; kéo thả trên lịch không đổi phòng.',
    ...
    'checkOutPrep.awaiting.hint':
      'Nhà cung cấp chưa xác nhận. Đóng phiếu bây giờ thì khoản này không còn chỗ để ghi vào.',
    'checkOutPrep.ready.title': 'Đủ điều kiện trả phòng',
    'checkOutPrep.owing.title': 'Đủ điều kiện trả phòng, còn {amount} chưa thu',
    'checkOutPrep.ready.hint':
      'Phiếu chi phí sẽ đóng và phòng chuyển sang cần dọn. Hóa đơn và khoản thu là bước sau, không tự đánh dấu đã thanh toán.',
  ...
  en: {
    ...
    'filter.needsAttention': 'Has a room to look at',
    ...
    'screen.tapeChart.legendHint':
      'Colour on the calendar is the state of a stay. Open one to check a guest in, move them or check them out; dragging on the calendar does not change a room.',
    ...
    'checkOutPrep.awaiting.hint':
      'A supplier has not confirmed these. Close the bill now and the charge has nowhere left to go.',
    'checkOutPrep.ready.title': 'Ready to check out',
    'checkOutPrep.owing.title': 'Ready to check out, {amount} still owed',
    'checkOutPrep.ready.hint':
      'The guest bill closes and the room becomes due for cleaning. Invoice and payment come after, and nothing here marks the stay as paid.',
