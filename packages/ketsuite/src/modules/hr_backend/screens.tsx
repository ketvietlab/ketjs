      ...
      rows.length
        ? dataTable(_, {
            ...
            columns: [
              ...
              { key: 'name', label: _('hr_backend.field.name'), cell: (row) => String(row.name) },
              {
                key: 'branch',
                label: _('hr_backend.field.branchId'),
                cell: (row) => String(row.homeBranchId),
              },
              {
                key: 'state',
                label: _('hr_backend.field.state'),
                cell: (row) => stateBadge(_, row.active ? 'active' : 'archived'),
              },
            ],
          })
            ...
            shifts.length
              ? dataTable(_, {
                  ...
                  columns: [
                    ...
                    { key: 'date', label: _('hr_backend.field.date'), cell: (row) => String(row.localDate) },
                    {
                      key: 'start',
