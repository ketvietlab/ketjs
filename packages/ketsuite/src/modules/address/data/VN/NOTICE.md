# Vietnam address data attribution
...
source identifiers are preserved as catalog codes; KetSuite does not represent
them as official statistical codes.

The upstream license identifier is
[LGPL-3.0](https://www.gnu.org/licenses/lgpl-3.0.html). KetSuite's loader,
generator, models and UI are original KetJS project code and remain under the
