...
export default defineModule({
  ...
  version: '0.1.0',
  depends: ['channel_api', 'purchase', 'partner', 'account'],
  compatible: { channel_api: '^1' },
  title: 'Purchasing Staff Channel',
  summary: 'Read-only purchasing vendor, order, and vendor-bill routes for staff clients.',
  category: 'Purchasing',
  routes: { ...channelRoutes, ...orderRoutes, ...vendorBillRoutes },
  messages: {
    vi: {
...
export { channelRoutes, orderRoutes, vendorBillRoutes }
