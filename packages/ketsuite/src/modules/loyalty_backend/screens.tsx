...
export const programsScreen = (
  ...
  framed(
    _,
    _('loyalty_backend.programs.title'),
    frame,
    stack([
      surface({
        body: recordForm({
...
export const walletsScreen = (
  ...
  framed(
    _,
    _('loyalty_backend.wallets.title'),
    frame,
    stack([
      surface({
        body: recordForm({
...
export const ledgerScreen = (_: Translator, frame: Frame, rows: AnyRow[]): TemplateResult =>
  framed(_, _('loyalty_backend.ledger.title'), frame, rows.length ? ledgerTable(_, rows) : empty(_))
...
export const membershipsScreen = (
  ...
  framed(
    _,
    _('loyalty_backend.memberships.title'),
    frame,
    stack([
      section({
...
export const orderLoyaltyScreen = (
  ...
  return framed(
    _,
    _('loyalty_backend.order.title', { order: options.orderName }),
    frame,
    stack([
      linkButton({
...
export const portalScreen = (_: Translator, frame: Frame, summary: AnyRow): TemplateResult => {
  ...
  return framed(
    _,
    _('loyalty_backend.portal.title'),
    frame,
    stack([
      ...(membership
        ? [
            cardGrid({
              items: [
                ...
                { id: 'points', title: _('loyalty_backend.field.points'), value: String(membership.points) },
                {
                  id: 'spend',
