import { designMessages } from './design-messages.ts'
const vi = {
  ...
  'menu.memberships': 'Hội viên',
  'menu.tiers': 'Hạng thành viên',
  'menu.ledger': 'Sổ cái',
  ...
  'members.title': 'Hội viên Loyalty',
  'members.hint': 'Danh sách phân trang từ dữ liệu thành viên hiện có; việc xem không tính lại hạng.',
  ...
  'field.activity': 'Hoạt động',
  'field.partnerState': 'Hồ sơ khách',
...
const en: Record<keyof typeof vi, string> = {
  ...
  'menu.memberships': 'Members',
  'menu.tiers': 'Membership tiers',
  'menu.ledger': 'Ledger',
  ...
  'wallet.adjustHint': 'Records an adjusting entry; the old balance stays in the ledger.',
  'wallet.recent': 'Recent activity',
  'wallet.about': 'Wallet or card',
  'wallet.entries': 'Entries',
  'wallet.quickActions': 'Quick actions',
  'wallet.inLedger': 'Open in the ledger',
  'tab.overview': 'Overview',
  'tab.ledger': 'Balance and activity',
  'tab.rules': 'Earning rules',
  'tab.rewards': 'Rewards',
  'ledger.title': 'Loyalty ledger',
  'memberships.title': 'Membership tiers',
  'memberships.hint': 'Each tier defines its own spend threshold and assessment period.',
  'memberships.windowExamples': 'Examples: 6 months, 12 months = 1 year, 120 months = 10 years.',
  'memberships.members': 'Members',
  'members.title': 'Loyalty members',
  'members.hint': 'A paged view of stored memberships; opening the list never recalculates a tier.',
  'tiers.title': 'Tiers',
  'tiers.hint': 'Select a row to open and edit a tier.',
  ...
  'field.partnerState': 'Customer record',
  ...
  'field.windowMonths': 'Spend period (months)',
  ...
  'stat.archivedHint': 'Hidden from customers',
  'stat.ended': 'Ended',
...
export const messages = {
  vi: { ...vi, ...designMessages.vi },
  en: { ...en, ...designMessages.en },
}
