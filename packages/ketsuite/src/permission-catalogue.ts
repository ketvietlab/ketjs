...
const sources = {
  ...
  hospitality_core: {
    ...
    functions: {
      ...
      cleaningTaskSummary: ['operate', ['operate', 'housekeeping-supervise']],
      ...
      getProperty: ['read', ['view', 'night-audit', 'reservation-input', 'revenue-operate']],
      ...
      listProperties: ['read', ['view', 'night-audit', 'reservation-input', 'revenue-operate']],
