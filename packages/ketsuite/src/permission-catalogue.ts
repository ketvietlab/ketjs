...
const sources = {
  ...
  crm: {
    ...
    functions: {
      ...
      'activity.schedule': ['operate', 'operate'],
      'assignmentRule.save': ['configure', 'configure', 'crm.configuration-audit'],
      'bootstrap.defaults': ['operate', 'operate'],
      'calendar.list': ['read', 'view'],
      'case.addMessage': ['operate', 'operate'],
      'case.assign': ['operate', 'operate'],
      'case.convertLead': ['operate', 'operate'],
      'case.count': ['read', 'view'],
      'case.detectDuplicates': ['operate', 'operate'],
      'case.get': ['read', 'view'],
      'case.group': ['operate', 'operate'],
      'case.list': ['read', 'view'],
      'case.markLost': ['approve', 'approve', 'crm.domain-policy'],
      'case.markWon': ['approve', 'approve', 'crm.domain-policy'],
      'case.merge': ['operate', 'operate'],
      'case.move': ['operate', 'operate'],
      'case.options': ['operate', 'operate'],
      'case.reassign': ['operate', 'operate'],
      'case.refreshScore': ['operate', 'operate'],
      'case.save': ['operate', 'operate'],
      'configuration.get': ['read', 'view'],
      'enrichment.preview': ['operate', 'operate'],
      'gamification.list': ['read', 'view'],
      'gamification.refresh': ['operate', 'operate'],
      'mining.preview': ['operate', 'operate'],
      overview: ['operate', 'operate'],
      'pipeline.summary': ['operate', 'operate'],
  ...
  hospitality_core: {
    ...
    functions: {
      ...
      amendReservation: ['operate', 'operate'],
      ...
      cancelCleaningTask: ['approve', 'approve', 'hospitality_core.domain-policy'],
      cancelReservation: ['approve', 'approve', 'hospitality_core.domain-policy'],
      checkIn: ['operate', 'operate'],
      checkOut: ['operate', 'operate'],
      cleaningTaskSummary: ['operate', 'operate'],
      completeCleaningTask: ['approve', 'approve', 'hospitality_core.domain-policy'],
      confirmStayNotice: ['approve', 'approve', 'hospitality_core.domain-policy'],
      createCleaningTask: ['operate', 'operate'],
      createReservation: ['operate', 'operate'],
      getBuilding: ['read', 'view'],
      getCleaningTask: ['read', 'view'],
      getFloor: ['read', 'view'],
      getFolio: ['read', 'view'],
      getHousekeepingRoom: ['read', 'view'],
      getProperty: ['read', 'view'],
      getReservation: ['read', 'view'],
      getRoom: ['read', 'view'],
      getRoomType: ['read', 'view'],
      getStay: ['read', 'view'],
      getTapeChart: ['read', 'view'],
      listAmenities: ['read', 'view'],
      listAmenityCategories: ['read', 'view'],
      listBuildings: ['read', 'view'],
      listCancellationPolicies: ['read', 'view'],
      listCleaningTasks: ['read', 'view'],
      listContentChanges: ['read', 'view'],
      listContentImages: ['read', 'view'],
      listExtraLines: ['read', 'view'],
      listFloors: ['read', 'view'],
      listFolios: ['read', 'view'],
      listGuestDocuments: ['read', 'view'],
      listInventory: ['read', 'view'],
      listInventoryChanges: ['read', 'view'],
      listNightAudits: ['sensitive', 'sensitive', 'hospitality_core.sensitive-data'],
      listProperties: ['read', 'view'],
      listPropertyCharges: ['read', 'view'],
      listRatePlans: ['read', 'view'],
      listReservations: ['read', 'view'],
      listRooms: ['read', 'view'],
      listRoomTypes: ['read', 'view'],
      listServiceCharges: ['read', 'view'],
      listServiceProducts: ['read', 'view'],
      listStayGuests: ['read', 'view'],
      listStayNotices: ['read', 'view'],
      listStays: ['read', 'view'],
      markNoShow: ['approve', 'approve', 'hospitality_core.domain-policy'],
      materializeExtraLine: ['operate', 'operate'],
      moveRoom: ['operate', 'operate'],
      previewNightAudit: ['sensitive', 'sensitive', 'hospitality_core.sensitive-data'],
      quoteReservation: ['operate', 'operate'],
      recordStayNoticeSubmission: ['operate', 'operate'],
      removeContentImage: ['operate', 'operate'],
      reorderContentImages: ['operate', 'operate'],
      requestNightAudit: ['sensitive', 'sensitive', 'hospitality_core.sensitive-data'],
      requestStayNoticeRefresh: ['operate', 'operate'],
      roomStatusSummary: ['operate', 'operate'],
      ...
      saveCancellationPolicy: ['configure', 'configure', 'hospitality_core.configuration-audit'],
      ...
      saveRatePlan: ['configure', 'configure', 'hospitality_core.configuration-audit'],
      ...
      setInventoryRange: ['configure', 'configure', 'hospitality_core.configuration-audit'],
      setPrimaryContentImage: ['configure', 'configure', 'hospitality_core.configuration-audit'],
      setRestrictionRange: ['configure', 'configure', 'hospitality_core.configuration-audit'],
      setRoomStatus: ['configure', 'configure', 'hospitality_core.configuration-audit'],
      startCleaningTask: ['operate', 'operate'],
  ...
  sale: {
    ...
    functions: {
      addLine: ['operate', 'operate'],
      cancelOrder: ['approve', 'approve', 'sale.domain-policy'],
      confirmOrder: ['approve', 'approve', 'sale.domain-policy'],
      countOrders: ['read', 'view'],
      createInvoice: ['operate', 'operate'],
      createOrder: ['operate', 'operate'],
      getOrder: ['read', 'view'],
      getProformaReport: ['sensitive', 'sensitive', 'sale.sensitive-data'],
      getQuotationReport: ['sensitive', 'sensitive', 'sale.sensitive-data'],
      getSalesOrderReport: ['sensitive', 'sensitive', 'sale.sensitive-data'],
      listInvoicePolicies: ['read', 'view'],
      listOrders: ['read', 'view'],
      lockOrder: ['approve', 'approve', 'sale.domain-policy'],
      removeLine: ['operate', 'operate'],
      resetOrder: ['operate', 'operate'],
      saveDraft: ['configure', 'configure', 'sale.configuration-audit'],
      sendQuotation: ['operate', 'operate'],
      setInvoicePolicy: ['configure', 'configure', 'sale.configuration-audit'],
      syncDeliveries: ['operate', 'operate'],
    },
    exemptions: {},
  },
  sale_backend: {
