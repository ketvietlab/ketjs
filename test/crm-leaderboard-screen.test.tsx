...
test('crm leaderboard: uses ListPage with rank, metrics, profile links and localized refresh', () => {
  ...
  assert.match(rendered, /data-ui="kt-cell" data-col="rank"[^>]*>.*?1/)
  assert.match(rendered, /data-ui="kt-cell" data-col="rank"[^>]*>.*?2/)
  assert.match(rendered, /data-ui="kt-cell" data-col="points"[^>]*>.*?142/)
  assert.match(rendered, /data-ui="kt-cell" data-col="won"[^>]*>.*?1/)
  assert.match(rendered, /data-ui="kt-cell" data-col="lost"[^>]*>.*?2/)
  assert.match(rendered, /data-ui="kt-cell" data-col="assigned"[^>]*>.*?6/)
  assert.match(rendered, /data-ui="kt-cell" data-col="activities"[^>]*>.*?4/)
